...
class Profile(models.Model):
    image = models.ImageField(upload_to="uploads/avatars/", default="../static/img/oblozka.jpg")
...
class LikesForAnswer(models.Model):
    ...
    def __str__(self):
        return self.author.user.username + " reaction: " + str(self.likes) + "on answer to the qusetion: " + self.answer.question.name
